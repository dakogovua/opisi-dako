...
//	var time=new Date();
	...
	var oneweek = new Date(currtime .setDate(currtime .getDate() + 7));

    var day = (oneweek.getDate() < 10) ? '0' + oneweek.getDate() : oneweek.getDate();

    var month = ((oneweek.getMonth() + 1 )< 10) ? '0' + (oneweek.getMonth() + 1 ): (oneweek.getMonth() + 1 );
    //var finalDate = '2022/01/01';
    var finalDate = oneweek.getFullYear()+'/'+month+'/'+day;

    console.log(day, 'oneweek', oneweek, finalDate)
