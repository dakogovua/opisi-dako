...
<div class="site-index">
    ...
    <div class="jumbotron">
        <h2>База даних оцифрованих описів справ Державного архіву Київської області періоду до 1917 року.</h2>

        

        <p><a class="btn btn-lg btn-success" href="/web/index.php?r=opisi/firstpage">Розпочнемо!</a></p>
    </div>
